...
tests_complex = generate_complex_tests(mealy_machine, max_length=3)

# Exécuter les tests simples sur la machine de Mealy
results_simple = execute_tests(mealy_machine, tests_simple)

# Exécuter les tests complexes sur la machine de Mealy
results_complex = execute_tests(mealy_machine, tests_complex)

# Afficher les résultats des tests simples
print("Tests Simples :")
for test, output in results_simple:
